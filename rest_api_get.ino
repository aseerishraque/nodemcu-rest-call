...
char ssid[] = "Aseer";         // your network SSID (name)
char password[] = "@fastfinish!113355"; // your network key
...
#define TEST_HOST "fiverr.ishraqulhoque.com"
...
//  client.setFingerprint(TEST_HOST_FINGERPRINT);
  ...
  makeHTTPRequest("101", "d6cefaf8");
}

void makeHTTPRequest(char machine_id[], char card_id[])
{
